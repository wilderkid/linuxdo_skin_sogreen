...
const HIGHLIGHT_TARGET_SELECTOR = [
    ...
    '.user-content.user-portfolio',
    '.user-activity-page section.about',
    '.user-activity-page .user-navigation',
    '.user-activity-page .post-list.user-stream',
    '.user-notifications-page section.about',
    '.user-notifications-page .user-navigation',
    '.user-notifications-page .notification-history',
    '.user-follow-page section.about',
    '.user-follow-page .user-navigation',
    '.user-follow-page .user-follows-tab',
    '.user-preferences-page section.about',
    '.user-preferences-page .user-navigation',
    '.user-preferences-page .user-preferences',
    '.user-badges-page section.about',
    '.user-badges-page .user-navigation',
    '.user-messages-page section.about',
    '.user-messages-page .user-navigation',
    '.user-messages-page .user-content',
    '.user-billing-page section.about',
    '.user-billing-page .user-navigation',
